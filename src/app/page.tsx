        ...
        <div className="relative z-10 max-w-7xl mx-auto py-20 px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Link
                href="/about"
                className="px-8 py-4 border border-gray-600 hover:border-blue-400 text-gray-300 hover:text-blue-300 font-semibold rounded-xl transition-all duration-300 backdrop-blur-sm"
              >
                Learn More
              </Link>
            </div>
              ...
              <div className="relative bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-sm border border-gray-700/30 rounded-2xl p-8">
                <div className="relative z-10">
                  ...
                  <p className="text-gray-500 mb-4 leading-relaxed">
                    An intelligent conversational AI built to help with daily
                    tasks and creative problem-solving.
                  </p>
                  <div className="flex flex-wrap gap-2">
          ...
          <div className="mb-16">
            ...
            <p className="text-gray-400 text-center mb-12 max-w-2xl mx-auto">
              Beyond AI experiments, exploring the frontiers of web3 and
